...
//for (int i = 0; i < 100; i++)
//{
//    Person personım = new Person()
//    {
//        Name = i.ToString(),
//        Department = i.ToString() + "Departmanı",

//    };
//    context.Persons.Add(personım);
//}
...
class BackingFieldDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=192.168.1.108;Initial Catalog=BackingFields;User ID=SA;Password=Password123;TrustServerCertificate=True");
    }
