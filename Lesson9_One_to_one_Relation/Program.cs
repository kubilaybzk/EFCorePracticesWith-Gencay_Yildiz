...
#region Default Convention Her iki entity'de Navigation Property ile birbirlerini tekil olarak referans ederek fiziksel bir ilişkinin olacağı ifade edilir.
//One to One ilişki türünde, dependent entity'nin hangisi olduğunu 
//default olarak belirleyebilmek pek kolay değildir. Bu durumda fiziksel 
...
//tercih ediyoruz ve bu duruma özen gösterilidir diyoruz.
...
//Fleunt API yönteminde entity'ler arasındaki ilişki context sınıfı içerisinde
//OnModelCreating fonksiyonun override edilerek metotlar aracılığıyla tasarlanması gerekmektedir.
//Yani tüm sorumluluk bu fonksiyon içerisindeki çalışmalardadır.
class Calisan
{
    public int Id { get; set; }
    public string Adi { get; set; }
...
class ESirketDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=192.168.17.123;Initial Catalog=OneToOne;User ID=SA;Password=Password123;TrustServerCertificate=True");
