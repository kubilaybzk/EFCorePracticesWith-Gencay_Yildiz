...
//TPC davranışı, kalıtımsal ilişkiye sahip olan entitylerin olduğu çalışmalarda
//sadece concrete/somut olan entity'lere karşılık bir tablo oluşturacak davranış modelidir.
//TPC, TPT'nin daha performanslı versiyonudur.
#endregion
#region TPC Nasıl Uygulanır?
//Hiyerarşik düzlemde abstract olan yapılar üzerinden OnModelCreating
//üzerinden Entity fonskiyonuyla konfigürasyona girip ardından UseTpcMappingStrategy fonksiyonu eşliğinde davranışın TPC olacağını belirleyebiliriz.
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=192.168.1.104;Initial Catalog=TablePerConcrete;User ID=SA;Password=Password123;TrustServerCertificate=True");
